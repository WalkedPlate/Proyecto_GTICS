...
INSERT INTO `categorias` VALUES (1,'Farmacos'),(2,'cuidado personal'),(3,'infantes');
...
INSERT INTO `ordenes` VALUES (1,11,1,1,'101',NULL,12,NULL,NULL,1,'2024-04-24',NULL,NULL,'2024-04-24'),(2,12,1,1,'102',NULL,14,NULL,NULL,2,'2024-04-24',NULL,NULL,'2024-04-24'),(3,13,2,2,'103',NULL,14,NULL,NULL,3,'2024-04-24',NULL,NULL,'2024-04-24'),(4,11,1,2,'104',NULL,11,NULL,NULL,NULL,'2024-04-24',NULL,NULL,'2024-04-24'),(5,11,1,2,'105',NULL,190,NULL,NULL,NULL,'2024-04-24',NULL,NULL,'2024-04-24'),(6,12,1,2,'106',NULL,11.2,NULL,NULL,NULL,'2024-04-24',NULL,NULL,'2024-04-24'),(7,12,1,2,'107',NULL,15,NULL,NULL,NULL,'2024-04-24',NULL,NULL,'2024-04-24'),(8,13,1,2,'108',NULL,15,NULL,NULL,NULL,'2024-04-24',NULL,NULL,'2024-04-24'),(9,12,1,2,'109',NULL,16,NULL,NULL,NULL,'2024-04-24',NULL,NULL,'2024-04-24');
...
CREATE TABLE `productos` (
  ...
  `preferencias_usuario_idpreferencias_usuario` int NOT NULL,
...
INSERT INTO `productos` VALUES (1,1,'paracetamol','PAR1',NULL,'para el dolor','2030-04-22',1,1),(2,1,'ibuprofeno','IBU2',NULL,'para la inflamación','2030-04-22',7.2,1),(3,1,'aspirina','ASP3',NULL,'para el dolor','2030-04-22',3.8,1),(4,1,'amoxicilina','AMO4',NULL,'para infecciones','2030-04-22',12.4,1),(5,1,'loratadina','LOR5',NULL,'antihistamínico','2030-04-22',6.75,1),(6,1,'omeprazol','OME6',NULL,'para la acidez estomacal','2030-04-22',8.9,1),(7,1,'simvastatina','SIM7',NULL,'para el colesterol','2030-04-22',15.3,1),(8,1,'metformina','MET8',NULL,'para la diabetes','2030-04-22',9.1,1),(9,1,'atenolol','ATE9',NULL,'para la presión arterial','2030-04-22',5.6,1),(10,1,'diazepam','DIA10',NULL,'para la ansiedad','2030-04-22',11.75,1),(11,1,'sertralina','SER11',NULL,'antidepresivo','2030-04-22',13.2,1),(12,1,'furosemida','FUR12',NULL,'diurético','2030-04-22',7.9,1),(13,1,'digoxina','DIG13',NULL,'para problemas cardíacos','2030-04-22',14.6,1),(14,1,'alprazolam','ALP14',NULL,'ansiolítico','2030-04-22',10.85,1),(15,1,'clopidogrel','CLO15',NULL,'anticoagulante','2030-04-22',17.4,1),(16,1,'trazodona','TRA16',NULL,'antidepresivo','2030-04-22',12.75,1),(17,1,'metronidazol','MET17',NULL,'antibiótico','2030-04-22',6.3,1),(18,1,'citalopram','CIT18',NULL,'antidepresivo','2030-04-22',11.2,1),(19,1,'levotiroxina','LEV19',NULL,'hormona tiroidea','2030-04-22',8.15,1),(20,1,'prednisona','PRE20',NULL,'corticosteroide','2030-04-22',9.8,1),(21,1,'metoclopramida','MET21',NULL,'para las náuseas','2030-04-22',7.3,1),(22,1,'quetiapina','QUE22',NULL,'antipsicótico','2030-04-22',14.7,1),(23,1,'fenitoina','FEN23',NULL,'antiepiléptico','2030-04-22',10.5,1),(24,1,'rosuvastatina','ROS24',NULL,'para el colesterol','2030-04-22',16.9,1),(25,1,'cefalexina','CEF25',NULL,'antibiótico','2030-04-22',6.75,1),(26,1,'risperidona','RIS26',NULL,'antipsicótico','2030-04-22',13.4,1),(27,1,'venlafaxina','VEN27',NULL,'antidepresivo','2030-04-22',11.9,1),(28,1,'metilprednisolona','MET28',NULL,'corticosteroide','2030-04-22',8.6,1),(29,1,'ranitidina','RAN29',NULL,'antihistamínico','2030-04-22',6.5,1),(30,1,'fluoxetina','FLU30',NULL,'antidepresivo','2030-04-22',10.2,1);
...
INSERT INTO `sedes` VALUES (1,'FarmaSalud','Av. Larco 123',NULL,'Miraflores'),(2,'Curafácil','Av. Conquistadores 456',NULL,'San Isidro'),(3,'SaludExpress','Av. Caminos del Inca 789',NULL,'Surco'),(4,'BienestarPlus','Av. Arequipa 101',NULL,'Lince'),(5,'RemediMax','Av. Bolognesi 202',NULL,'Barranco'),(6,'MediRápido','Av. Javier Prado Oeste 303',NULL,'Magdalena del Mar'),(7,'SaludTotal','Av. Aviación 404',NULL,'San Borja'),(8,'VitalFarma','Av. Brasil 505',NULL,'Jesus María'),(9,'CuraBien','Av. La Fontana 606',NULL,'La Molina'),(10,'Farmaxima','Av. Bolívar 707',NULL,'Pueblo Libre');
